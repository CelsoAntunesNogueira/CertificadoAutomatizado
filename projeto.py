...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2)): # cada célula que contém a info que precisamos
    ...
    #Colocando as coordenadas para colocar o texto em cada parte da imagem
    ...
    #gerando o certificado com numeração e ordem alfabética e colocando em uma pastaseparada
